...
public class Transaction {
	...
	public Transaction(int transactionType, Date transactionCreateTime, String transactionStatus, int payerId,
			int receiverId, double transactionAmount, int status, int auth, String status_quo) {
		super();
		this.transactionType = transactionType;
		this.transactionCreateTime = transactionCreateTime;
		this.payerId = payerId;
	...
	public Transaction(int transactionId, int transactionType, Date transactionCreateTime, int payerId,
			int receiverId, double transactionAmount, int status, int auth, String status_quo) {
		super();
		this.transactionId = transactionId;
		this.transactionType = transactionType;
