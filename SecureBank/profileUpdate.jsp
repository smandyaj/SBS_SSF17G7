			...
			<c:forEach var="user" items="${users}">
				<tr>
					<td>${user.userId}</td>
						...
						<spring:url value="/employee/pending-profile/${user.modId}" var="profileUpdateApprovalUrl" />
						<spring:url value="/employee/pending-transactions/${user.modId}" var="profileUpdateDeclineUrl" />
