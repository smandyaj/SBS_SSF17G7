...
public class InternalUserDAOImpl implements InternalUserDAO{
	...
	public void delete(Integer id) {
		...
		if( internalUser != null) {
			getCurrentSession().delete(internalUser);
			Role role = roleDAO.findRoleByUserName(internalUser.getUserName());
			roleDAO.deleteRole(role.getRoleId());
			Users user = userDAO.findRoleByUserName(internalUser.getUserName());
