 ...
 <div class="col-sm-9 col-md-10 main">
          ...
          <c:if test="${!empty successMsg}">
            ...
            <p>
              ...
              <form:input  path = "customerId" type="text" class="form-control" onkeypress="return isNum(event)" placeholder="ex: 123456789" maxlength="11" minlength="1" required= "required"></form:input>
            </p>
