	...
	<form:form id="fund-transfer" action="addTransactionSuccess" method="POST" modelAttribute="transaction" htmlEscape="true">
		<div class="modal-body">
				...
				<div id="external-transfer" class="hidden">
					<p>
						<label>Beneficiery Account Number:</label> <input type="text"
							class="form-control" onkeypress="return isNum(event)" name="receiverAccNumberExternal"
							placeholder="eg: 1234">
					</p>
				</div>
				<hr>
			<p>
				...
				<input name="amount" type="text" class="form-control" onkeypress="return isNumberKey(event)" placeholder="e.g. 10.50">
