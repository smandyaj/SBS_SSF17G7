...
<body role="document">
	...
	<form:form id="fund-transfer" action="addTransactionSuccess" method="POST" modelAttribute="ExternalUserTransactionResult">
		<div class="modal-body">
			...
			<div>
				<label>Transfer Type:</label><br> <span
					style="margin-right: 30px;"> <input type="radio" checked="checked" name="type"
			...
			<div class="transfer-account-details">
				...
				<div id="external-transfer" class="hidden">
                    ...
                    <span><input type="radio" name="type" value="External" id="radioPhone"
                    class="external-transfer transfer-option-btn"> <label>Beneficiery Phone Number:</label> <input type="text"
                    class="form-control" id="textPhone" name="receiverPhoneNumberExternal"
                    placeholder="eg: 480***27**"></span> <br>

                    <span> <input type="radio" name="type" id="radioEmail"
                        value="External" class="external-transfer transfer-option-btn">
                        <label>Beneficiery Email Id:</label> <input type="text"
                        class="form-control" id="textEmail" name="receiverEmailIdExternal"
                        placeholder="eg: abc@xyz.com"></span> <br>

                    <span><input type="radio" name="type" value="External" id="radioAcc"
                        class="external-transfer transfer-option-btn" checked="checked"><label>Beneficiery Account Number:</label> <input type="text"
                        class="form-control" id="textAccNum" name="receiverAccNumberExternal"
