...
jQuery(document).ready(function() {
	$('.form-control').bind('keypress', function (e) {
	    if ($('.form-control').val().length == 0) {
	        ...
	        var valid = (e.which >= 48 && e.which <= 57) || (e.which >= 64 && e.which <= 90) || (e.which >= 97 && e.which <= 122);
	        if (!valid) {
	            e.preventDefault();
	        }
	    } else {
	        var valid = (e.which >= 48 && e.which <= 57) || (e.which >= 64 && e.which <= 90) || (e.which >= 97 && e.which <= 122 || e.which == 32 || e.which == 95 || e.which == 8);
	        if (!valid) {
	            e.preventDefault();
	        }
	    }
