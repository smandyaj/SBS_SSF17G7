			...
			<div>
				...
				<div class="modal-body">
					...
					<p>
						...
						<input name="senderAccNumber" type="text" onkeypress="return isNum(event)" class="form-control" placeholder="e.g. 5">
						<form:errors path="senderAccNumber" cssClass="error" element="label"/>
					</p>
					<p>
						<label>Request Amount:</label>
						<input name="amount" type="text" onkeypress="return isNumberKey(event)" class="form-control" required pattern="[-+]?(\d*[.])?\d+" placeholder="e.g. 10.50">
